  ...
  const html=
    '<div style="display:grid;gap:18px;margin-top:18px">'+
      ...
      '<section>'+
        ...
        '<p><b>Escuela:</b> '+(clean(get('schoolName'))||'—')+'</p>'+
        '<p><b>Grado:</b> '+(clean(get('grade'))||'—')+'</p>'+
        '<p><b>Fase:</b> '+(clean(get('phase'))||'—')+'</p>'+
        '<p><b>Campo formativo:</b> '+(clean(get('field'))||'—')+'</p>'+
        '<p><b>Duración:</b> '+(clean(get('duration'))||'—')+'</p>'+
      '</section>'+

      '<section>'+
        '<h3>2. Proyecto</h3>'+
        '<p><b>Escenario:</b> '+scenario+'</p>'+
        '<p><b>Metodología:</b> '+methodology+'</p>'+
        '<p><b>Nombre del proyecto:</b> '+project+'</p>'+
      '</section>'+
      ...
      '<section>'+
        ...
        '<p><b>Contenido:</b> '+(clean(item?.content||'')||'—')+'</p>'+
        '<p><b>PDA seleccionados:</b></p>'+
        '<ol>'+pdasHtml+'</ol>'+
      '</section>'+

      '<section>'+
        '<h3>5. Contexto y necesidades del grupo</h3>'+
        '<div style="white-space:pre-wrap;line-height:1.6;padding:14px;border-radius:10px;background:#f7f8fc;">'+
          (safeContext||'—')+
        '</div>'+
      '</section>'+
